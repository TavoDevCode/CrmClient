...
const ClientRow = ({ client }) => {
    const { id, name, last_name, business, email, phone } = client;

    const { deleteClientConfirm } = useDeleteClient(client);
    ...
    return (
        <tr>
            ...
            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                <p className="text-gray-900 whitespace-no-wrap">{business}</p>
            </td>
            <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
